                                ...
                                BMRCalculatorDescription(desCollapsed: $descriptionCollapsed)
                                    ...
                                    .background(
                                        ...
                                        DispatchQueue.main.async {
                                            let descriptionTopPosition = geo.frame(in: .global).minY - 32
                                            ...
                                            if descriptionTopPosition<40 && faqPosition>40 && !transitionToFAQ{
                                                index = 0
...
//                                .frame(width:0,height:0)
                                FAQSectionDisplay( FAQExpand: $FAQExpand)
                                    ...
                                    .background(GeometryReader{ geo -> AnyView in
                                        ...
                                        DispatchQueue.main.async {
                                            let FAQTopPosition = geo.frame(in: .global).minY - 16
                                            faqPosition = FAQTopPosition
                                            if FAQTopPosition<40 && descriptionPosition < -80 && !transitionToDescription{
                                                index = 1
            ...
            VStack {
                ScrollTabs(descriptionCollapsed: $descriptionCollapsed, transitionToDescription: $transitionToDescription, transitionToFAQ: $transitionToFAQ, index: $index,proxy: reader, FAQExpand: $FAQExpand)
                    .offset(y: scrollTabsMinY>60 ? scrollTabsMinY : 60 )
                // scroll tabs is blocked at 40 and wont go any higher
                Spacer()
            }
                ...
                Text("常见问题")
                    ...
                    .onTapGesture {
                        if self.index != 1{
                            ...
                            withAnimation{
                                proxy.scrollTo("faq", anchor: .init(x:UnitPoint.top.x,y:UnitPoint.top.y-0.12))
