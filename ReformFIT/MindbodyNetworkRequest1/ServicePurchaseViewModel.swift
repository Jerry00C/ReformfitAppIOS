...
class ServicePurchaseViewModel: ObservableObject{
    ...
    private var serviceAPIRequest: MindbodyAPIRequest<ServiceResource>?
    
    deinit {
        print("this view model is deinitialized ")
    }
    ...
    func requestService(serviceId: String, authToken: String, onCompletion:@escaping()->Void){
        ...
        serviceAPIRequest = MindbodyAPIRequest<ServiceResource>(resource: serviceResource, requestBody: nil, method: "GET")
