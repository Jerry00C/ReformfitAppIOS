        ...
        NavigationView{
         ...
         ZStack {
             ...
             VStack{
                 switch selectedTab{
                     case .first:
                        LocationMain(locationViewModel: LocationViewModel(), fab: $fab)
             ...
             if fab{
                ...
                MineMain(bottomView: $bottomView)
             ...
             VStack{
                 SocialMain().opacity(0)
                 
                fabView(fab: $fab).opacity(bottomView ? 0 : 1)
         ...
         .navigationBarTitleDisplayMode(.inline)
                 .toolbar { // <2>
                     ToolbarItem(placement: .principal) { // <3>
                         VStack {
                             Text("REFORMFIT健身").font(.headline)
                         }
                     }
                 }
        }
